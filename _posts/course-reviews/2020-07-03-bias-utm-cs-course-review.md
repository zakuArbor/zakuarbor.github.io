...
categories: [university, computer science, reviews]
...
**DISCLAIMER 2:** This blog post is **OUTDATED**, many things have likely changed since when you are reading this webpage
...
<img src = "{{ site.baseurl }}/assets/utm/collage1920x1080.jpg" alt = "my personal wallpaper with all my favorite professors" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/csc207_paint.png" alt = "an example of a CSC207 Paint Project" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/fsm.jpg" alt = "a manga talking about finite state machines" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/pointer_joke.png" alt = "a comic making a pointer joke" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/pcrs_meme.jpeg" alt = "a meme joking about the consequences of not completing your weekly pcrs excercise" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/bash_kill.jpeg" alt = "a joke on the terminal about kill" class = "center"/>
<p class = "excerpt">Excerpt from the official 2020 CSC209 Meme Thread</p>
...
<img src = "{{ site.baseurl }}/assets/utm/goose_chat.png" alt = "an example of a chat server made by students in CSC209" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/csc258_manga.jpg" alt = "The cover of the Manga Guide to Microprocessors" style = "float:left;" class = "half-img"/>
<img src = "{{ site.baseurl }}/assets/utm/csc258_book.jpg" alt = "The cover of the book Code" style = "float:right;"  class = "half-img"/>
</div>
</center>
...
<img src = "{{ site.baseurl }}/assets/utm/min-heap-joke.jpeg" alt = "a joke about min-heap" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/dan_book.jpg" alt = "The cover of Algorithmic Thinking" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/paper-exam.png" alt = "A student questioning why her friend held a programming test on paper" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets//utm/ww_reg.jpg" alt = "An example of my Warehouse War login screen" style = "float:left;" class = "img_50"/>
<img src = "{{ site.baseurl }}/assets//utm/ww_game.jpg" alt = "An example of my Warehouse War gameplay" style = "float:right;" class = "img_50"/>
</div>
</center>
<p class = "excerpt">An example of a CSC309 A2 project back in 2017</p>

<img src = "{{ site.baseurl }}/assets/utm/fortnite.png" alt = "An example of the fortnite game students made in CSC309" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/q3_techpanda.org_.png" alt = "An example as to why you should never make an account nor log into any non-SSL encrypted website" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/proxy_server.png" alt = "An example of a webpage cached by the proxy server created from A1" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/ilir-udp.jpeg" alt = "A Network joke about how handshakes have been switched to UDP due to Covid-19"/>
...
<div class = "double_img center" style = "height: 500px;">
	<img src = "{{ site.baseurl }}/assets/utm/363-1.png" alt = "A professor relating dating sims to NP-Hard to motivate his research student" style = "float:left;" class = "img_40"/>
	<img src = "{{ site.baseurl }}/assets/utm/363-2.png" alt = "A turing machine that determines whether a person loves each other or not" style = "float:right;" class = " img_60"/>	
</div>
...
<img src = "{{ site.baseurl }}/assets/utm/363-3.jpg" alt = "A student questioning why they are learning about computing theory when all they want to learn is how to program a video game" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/363-4.png" alt = "A senior teasing her friend that he would need to repeat a year if he fails his computation theory course" class = "center"/>
<p class = "excerpt">Excerpt from Rikei ga Koi ni Ochita no de Shoumei shitemita</p>
...
<img src = "{{ site.baseurl }}/assets/utm/363-5.png" alt = "A student being frustrated how textbooks and papers use difficult and abstract explanations in theory courses" class = "center"/>
<p class = "excerpt">Excerpt from Rikei ga Koi ni Ochita no de Shoumei shitemita</p>
...
<img src = "{{ site.baseurl }}/assets/utm/367-sample1.png" alt = "A screenshot of a CSC367 Report with graphs" style = "float:left;" class = "img_40"/>
<img src = "{{ site.baseurl }}/assets/utm/367-sample2.png" alt = "A screenshot of a CSC356 Report" style = "float:right;" class = "img_60"/>
</div>
...
<div class = "multiple_img_div center">
<img src = "{{ site.baseurl }}/assets/utm/zaku.jpg" alt = "Raw image of a zaku before applying Laplacian filter over it" style = "float:left;" class = "img_50"/>
<img src = "{{ site.baseurl }}/assets/utm/zaku_filter.jpg" alt = "Image of a zaku after applying a Laplacian filter over it" style = "float:right;" class = " img_50"/>
</div>
...
<img src = "{{ site.baseurl }}/assets/utm/csc373.png" alt = "Professor Maccio's youtube channel which hosts video lectures of CSC373" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/376_sim.png" alt = "An image of a simulator trying to place a ball through different spots around its surroundings" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets/utm/csc384-a2.gif" alt = "A sample of Assignment 2: Sokoban. The AI is avoiding the enemy while also trying to collect all the items on the map" class = "center"/>
<p class = "excerpt">An image of a simulator trying to place a ball through different spots around its surroundings</p>
...
<img src = "{{ site.baseurl }}/assets/utm/csc384-2.png" alt = "A lecture slide trying to figure out why Jacques transforms into a squrriel" class = "center"/>
...
<img src = "{{ site.baseurl }}/assets//utm/unrealircd-exploit.jpg" alt = "An image of metasplot exploting a server" class = "center"/><!-- image source: I no longer remember but I do not think it's owned by me-->
...
<img src = "{{ site.baseurl }}/assets/utm/427-steg.png" alt = "An image of metasplot exploting a server" class = "center"/>
...
<div class = "multiple_img_div center">
	<img src = "{{ site.baseurl }}/assets/utm/proxy-1.png" alt = "Title page of my paper" class = "img_33"/>
	<img src = "{{ site.baseurl }}/assets/utm/proxy-2.png" alt = "Table of Contents of my paper" class = "img_33"/>
	<img src = "{{ site.baseurl }}/assets/utm/proxy-3.png" alt = "The first page of my paper" class = "img_33"/>
</div>
...
<div class = "multiple_img_div center">
	<img src = "{{ site.baseurl }}/assets/utm/vesta-1.png" alt = "Title page of my paper" class = "img_33"/>
	<img src = "{{ site.baseurl }}/assets/utm/vesta-2.png" alt = "Table of Contents of my paper" class = "img_33"/>
	<img src = "{{ site.baseurl }}/assets/utm/vesta-3.png" alt = "The first page of my paper" class = "img_33"/>
</div>
