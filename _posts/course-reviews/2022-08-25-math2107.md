...
![A snippet from The Manga Guide to Linear Algebra]({{site.baseurl}}/assets/math-physics/lin-1.png)
...
![An edited image I found where Komi-san is babbling about vector spaces]({{site.baseurl}}/assets/math-physics/manga/komi-linear.jpg) <!--(https://pbs.twimg.com/media/DxscBpKXQAEqcd0?format=jpg&name=small)-->
...
![A snippet from the back cover of the manga guide to linear algebra]({{site.baseurl}}/assets/math-physics/manga/manga-linear-eigen.png)
...
![A geometric visual of a projection on a plane]({{site.baseurl}}/assets/math-physics/lin-ortho-proj.jpg)
...
![A crude way to find the line of best fit]({{site.baseurl}}/assets/math-physics/phys-least-square-crude.jpg)
...
![Maybe the method to find the least squares?]({{site.baseurl}}/assets/math-physics/phys-maybe-least-squares.jpg)
...
![A visualization of z = 0.5x^2 which is a semi-positive definite quadratic form]({{site.baseurl}}/assets/math-physics/graphs/lin-pos-semidef.png)
...
![A visualization of z = 0.5x^2 + 0.5y^2 which is a positive definite quadratic form]({{site.baseurl}}/assets/math-physics/graphs/lin-pos-def.png)
...
![An image of how webwork looks like]({{site.baseurl}}/assets/math-physics/webwork.jpg)
...
![Be Interested from Yulei Larry Zhang lecture slides]({{site.baseurl}}/assets/personal/csc369-be-interested.png)
...
![An image of my course notes]({{site.baseurl}}/assets/math-physics/math2107-notes.jpg)
...
![An image of my cue cards]({{site.baseurl}}/assets/math-physics/cue-cards.jpg)
