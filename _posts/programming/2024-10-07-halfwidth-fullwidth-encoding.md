...
![Full and Half Width Characters encoded on UTF-8]({{ site.url }}/bl{{ site.baseurl }}/assets/programming/encoding/full-half-width.png)
...
![ASCII Table From Wikipedia]({{ site.baseurl }}/assets/programming/encoding/ascii-table.png)
...
![JIS C 6220 chart]({{ site.baseurl }}/assets/programming/encoding/jis-c-6220.png)
...
![ISO 8859-14]({{ site.baseurl }}/assets/programming/encoding/iso-8859.png)
...
![Using charset.7jp.net to view the HEX representation of ア and ｱ]({{ site.baseurl }}/assets/programming/encoding/shift-jis-ah.png)
