...
![A gif showing the difference between size of long on Windows and Linux on the same architecture]({{ site.baseurl }}/assets/programming/builds/windows-linux-longint.gif)
