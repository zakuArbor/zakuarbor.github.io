...
![An example of GPG used to sign commits]({{ site.baseurl }}/assets/programming/security/github-gpg.png)
...
<img src = "{{ site.baseurl }}/assets/programming/security/email-gpg.png" class = "img_33">
<img src = "{{ site.baseurl }}/assets/programming/security/fedora-gpg.png" class = "img_60">
</div>
...
![Gmail Expanded Menu to Downloads the email]({{ site.baseurl }}/assets/programming/misc/gmail-menu-expanded.png)
...
![An image of an edited eml file that does not contain attachments aside from the signature]({{ site.baseurl }}/assets/programming/security/email-no-attachment.png)
...
![An illustration of what is part of the signed message]({{ site.baseurl }}/assets/programming/security/email-signed-msg.png)
