...
![GNOME System Menu With a VPN Symbol]({{ site.baseurl }}/assets/personal/gnome-system-menu-vpn.png)

![GNOME VPN Icons - https://help.gnome.org/users/gnome-help/stable/status-icons.html.en]({{ site.baseurl }}/assets/personal/gnome-vpn-icons.png)
...
![GNOME Network Settings]({{ site.baseurl }}/assets/personal/gnome-settings-network.png)
...
![NordVPN Dashboard - Taken from NordVPN website]({{ site.baseurl }}/assets/personal/nordvpn-dashboard.png)

![A Sample of GNOME when trying to add a VPN]({{ site.baseurl }}/assets/personal/gnome-add-vpn-2.png)

Now you have a very convenient place to connect to the VPN that is not through the terminal.

<video autoplay loop>
<source src = "{{ site.baseurl }}/assets/personal/gnome_vpn.webm" type="video/webm" alt = "a video showing you how to connect to VPN using GNOME VPN Plugin">
