...
![Creating an index.html file on the special repository under the directory test]({{ site.baseurl }}/assets/personal/github-page-spec-1.png)
                                                                                
<p class = "caption">Creating an index.html file on the special repository under the directory test</p>

![The webpage that gets rendered after creating a special github repository and an html file under a directory called test]({{ site.baseurl }}/assets/personal/github-page-spec-2.png)
...
![The content of index.html on the new repository named test]({{ site.baseurl }}/assets/personal/github-page-1.png)

<p class = "caption">The content of index.html on the new repository named test</p>

![The webpage that gets rendered is the index.html belonging to the new repository and not the webpage under the special repository]({{ site.baseurl }}/assets/personal/github-page-2.png)
