...
undergrad ([I wrote a series of blog posts on my rational]({{ site.url }}/blog/categories/#back-to-school)). 
...
![Drawing a box over an equation and over some polynomial function to highlight their relationship]({{ site.baseurl }}/assets/math-physics/tex-boxes.png)
